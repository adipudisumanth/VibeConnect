...
public interface ProjectService  {
    ...
    void incrementFilledOpenings(Long projectId) throws ProjectNotFoundException;
    void decrementFilledOpenings(Long projectId) throws ProjectNotFoundException;
